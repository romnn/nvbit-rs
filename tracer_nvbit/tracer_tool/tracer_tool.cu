...
// nothing from this is actually in the code, but it must be included
// if it is not included, there will be a runtime error:
// MSG: instrumentation function gen_mref_addr not found in binary!
#include "nvbit_tool.h"

// nvbit interface file
// used for enable_instrumented etc.
#include "nvbit.h"
...
/* // instrument each memory instruction adding a call to the */ 
/* // above instrumentationfunction */
